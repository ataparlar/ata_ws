...
bool ElevationMapping::readParameters()
{
  ...
  nodeHandle_.param("robot_pose_with_covariance_topic", robotPoseTopic_, string("/base_footprint_pose"));  // /pose
  nodeHandle_.param("track_point_frame_id", trackPointFrameId_, string("/base_footprint")); // /robot
  ...
  string frameId;
  nodeHandle_.param("map_frame_id", frameId, string("/base_link")); // /map
